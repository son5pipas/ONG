...
//		abrirRegistro();///////////////////////////////////////////////////////////////BORRAR
	...
	private void panelNorte() {
		...
		norte.pintar(MainController.LOGO, 5, 5, 330, 90);
		...
		JButton noRegistrados = new JButton();
		noRegistrados.setText("Sin Registro");
		noRegistrados.setBounds(680, 60, 150, 25);

		noRegistrados.addActionListener(controlador);
		noRegistrados.setActionCommand(MainController.NOREGISTER);

		norte.add(user);
		norte.add(pass);
		norte.add(login);
		norte.add(registro);
		norte.add(noRegistrados);
	...
	public void refillLogin(){
		refill.setText("* ¡Debe introducir usuario y contraseña! *");
		refill.setBounds(832, 2, 350, 25);
